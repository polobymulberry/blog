...
{% asset_img nvcc-whole-compilation.png %}
...
{% asset_img nvcc-options-for-separate-compilation.png %}
...
{% asset_img virtual-architectures.png %}
...
{% asset_img just-in-time-compilation.png %}

## 0x05 : 整体流程详解

CUDA的整体编译链接过程如图所示：

{% asset_img cuda-compilation-from-cu-to-executable.png %}
...
4. 用fatbinary将不同的Virtual Architecture生成的.ptx文件和.cubin合并在一起生成.fatbin.c文件。之所以要将.ptx和.cubin文件一起塞到.fatbin.c中，是因为.ptx代表Virtual Architecture，而.cubin代表Real Architecture，当然这只是我的猜测。
